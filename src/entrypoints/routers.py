...
async def get_calendar(
    ...
    await service_layer.create_calendar(year, start_kathisma)
    return TEMPLATE.TemplateResponse('calendar.html', context=dict(request=request, year=year, start_kathisma=start_kathisma))
